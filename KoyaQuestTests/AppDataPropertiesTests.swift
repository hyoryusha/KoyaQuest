...
class AppDataPropertiesTests: BaseTestCase {
    ...
    func testTotalScore() {
        ...
        appData.completedChallengeSummary = completedChallengeSummary
        appData.completedBonusSummary = completedBonusSummary
        XCTAssertEqual(appData.totalScore, 114 + 32, "Total score for three challenges should be 106")
    }

    func testProgressString() throws {
        appData.completedChallengeSummary = completedChallengeSummary

        XCTAssertEqual(appData.progressString, "Completed 4 out of 12 Challenges.", "Progress string should say 4 out of 12.")
    }

    func testBonusProgressString() throws {
        appData.completedBonusSummary = completedBonusSummary

        XCTAssertEqual(appData.bonusProgressString, "Completed 2 out of 6 Bonus Questions.", "Progress string should say 2 out of 6.")
    }
}
